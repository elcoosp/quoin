...
fn get_children(name: &str) -> Option<Vec<SvgChild>> {
    Some(match name {
        "calendar" => vec![
            ...
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M3 10h18")],
            },
        ],
        "info" => vec![
            SvgChild {
                tag: "circle",
                attrs: vec![("cx", "12"), ("cy", "12"), ("r", "10")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M12 16v-4")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M12 8h.01")],
            },
        ],
        "search" => vec![
            SvgChild {
                tag: "circle",
                attrs: vec![("cx", "11"), ("cy", "11"), ("r", "8")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "m21 21-4.3-4.3")],
            },
        ],
        "close" | "x" => vec![
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M18 6 6 18")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "m6 6 12 12")],
            },
        ],
        "trash" => vec![
            SvgChild {
            ...
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2")],
            },
        ],
        "copy" => vec![
            SvgChild {
        ...
        "check" => vec![SvgChild {
            tag: "path",
            attrs: vec![("d", "M20 6 9 17l-5-5")],
        }],
        "chevron-down" => vec![SvgChild {
            tag: "path",
            attrs: vec![("d", "m6 9 6 6 6-6")],
        }],
        "chevron-right" => vec![SvgChild {
            tag: "path",
            attrs: vec![("d", "m9 18 6-6-6-6")],
        }],
        "folder" => vec![SvgChild {
            tag: "path",
            attrs: vec![(
        ...
        "inbox" => vec![
            SvgChild {
                tag: "polyline",
                attrs: vec![("points", "22 12 16 12 14 15 10 15 8 12 2 12")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![(
        ...
        "file" => vec![
            ...
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M14 2v4a2 2 0 0 0 2 2h4")],
            },
        ],
        "play" => vec![SvgChild {
            tag: "polygon",
            attrs: vec![("points", "6 3 20 12 6 21 6 3")],
        }],
        "map" => vec![
            SvgChild {
                tag: "path",
            ...
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M15 5.764v15")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M9 3.236v15")],
            },
        ],
        "loader" | "refresh" => vec![
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74")],
            },
            SvgChild {
                tag: "path",
                attrs: vec![("d", "M21 3v6h-6")],
            },
        ],
        _ => return None,
    })
