...
pub(crate) fn emit_sheet(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    #[cfg(feature = "leptos-shadcn")]
    {
        ...
        let alias = quote::format_ident!("Sheet_{}", next_extract_id());
        bindings.push(quote! { let #alias = leptos_shadcn_ui::Sheet; });
...
fn make_sheet_component(name: &str, el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    #[cfg(feature = "leptos-shadcn")]
    {
        use super::bindings::next_extract_id;
...
pub(crate) fn emit_sheet_trigger(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    make_sheet_component("SheetTrigger", el, bindings, inside_for)
}
pub(crate) fn emit_sheet_content(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    make_sheet_component("SheetContent", el, bindings, inside_for)
}
pub(crate) fn emit_sheet_title(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    make_sheet_component("SheetTitle", el, bindings, inside_for)
}
pub(crate) fn emit_sheet_description(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
    make_sheet_component("SheetDescription", el, bindings, inside_for)
}
