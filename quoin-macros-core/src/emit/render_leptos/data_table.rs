use crate::emit::common::{find_arg_bool, find_arg_expr, find_arg_f32};
...
pub(crate) fn emit_data_table(el: &Element, bindings: &mut Vec<TokenStream>, inside_for: bool) -> TokenStream {
